const hero = { "title": "راه‌بان", "phone": "09123456789" };
const services = [{ "icon": "car_crash", "title": "یدک‌کش نیسان چرخ‌گیر", "description": "حمل تخصصی با سیستم چرخ‌گیر هیدرولیک بدون آسیب به خودرو.", "price": "400,000" }, { "icon": "build", "title": "مکانیک سیار", "description": "عیب‌یابی و تعمیرات در محل.", "price": "250,000" }, { "icon": "battery_charging_full", "title": "امداد باطری", "description": "باطری به باطری سریع و تست دینام.", "price": "180,000" }, { "icon": "tire_repair", "title": "پنچرگیری", "description": "تعویض لاستیک و پنچرگیری تخصصی.", "price": "150,000" }];
const testimonials$1 = [{ "name": "سارا قنبری", "car": "کیا سراتو", "text": "توی اتوبان گیر کرده بودم و خیلی استرس داشتم. امدادگر خیلی با اخلاق بود و با احتیاط کامل ماشین رو تا نمایندگی حمل کردن. ممنون از تیم خوبتون." }, { "name": "مریم احمدی", "car": "سمند سورن", "text": "واقعاً از سرعت عملشون غافلگیر شدم. کمتر از ۱۵ دقیقه رسیدن و نیسانشون خیلی تمیز و مجهز بود. چرخ‌گیرشون هیچ صدمه‌ای به سپرم نزد." }, { "name": "محمد کریمی", "car": "تویوتا کرولا", "text": "قیمتشون دقیقاً همونی بود که پشت تلفن گفتن. تجهیزاتشون بسیار مدرن بود و راننده نیسان خیلی مسلط بود. امنیت خودرو کاملاً حفظ شد." }];
const coverage$1 = [{ "city": "شاهین دژ", "eta": "15 دقیقه" }, { "city": "محمودآباد (محمودجیق)", "eta": "25 دقیقه" }, { "city": "کشاورز", "eta": "35 دقیقه" }, { "city": "میاندوآب", "eta": "75 دقیقه" }, { "city": "بوکان", "eta": "60 دقیقه" }, { "city": "تکاب", "eta": "85 دقیقه" }];
const rawData = {
  hero,
  services,
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-slate-400">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <span dir="ltr">${data$3.phone}</span>
                        </li>
                        <li class="flex items-center gap-3">
            ...
            <div class="flex justify-between items-center h-20">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">امداد خودرو <span
                            class="text-primary">${data$2.title}</span></span>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a class="hidden sm:flex items-center gap-2 bg-primary hover:bg-accent text-slate-900 font-bold py-2 px-6 rounded-lg transition-all transform hover:scale-105"
                        href="tel:${data$2.phone}">
                        <span class="material-icons">phone_in_talk</span>
                        <span>${data$2.phone}</span>
                    </a>
...
function renderServices() {
  const cards = rawData.services.map((service) => renderServiceCard(service)).join("");
  return `
...
const data = rawData.hero;
function renderStickyCall() {
  return `
  <div
...
const testimonials = rawData.testimonials;
function renderTestimonials() {
  const items = testimonials.map((t) => renderTestimonialCard(t)).join("");
  return `
