...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  <nav
    ...
    <section class="py-24 bg-slate-50 dark:bg-background-dark/50 transition-colors" id="pricing-services">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-primary font-bold tracking-widest uppercase text-sm">لیست خدمات و تعرفه‌ها</span>
                <h2 class="text-3xl md:text-4xl font-bold mt-2 mb-4 text-slate-900 dark:text-white">خدمات تخصصی امداد
                    نیسان</h2>
                <div class="h-1.5 w-24 bg-primary mx-auto rounded-full"></div>
                <p class="mt-6 text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">تعرفه‌های ما بر اساس نرخ مصوب
                    اتحادیه و با شفافیت کامل محاسبه می‌گردد. بدون هزینه‌های پنهان.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div
                    class="bg-white dark:bg-card-dark p-8 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-xl dark:hover:shadow-primary/5 transition-all group flex flex-col h-full">
                    <div
                        class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
                        <span
                            class="material-symbols-outlined text-primary group-hover:text-background-dark text-4xl">car_crash</span>
                    </div>
                    <h3 class="text-xl font-bold mb-4 text-slate-900 dark:text-white">یدک‌کش نیسان چرخ‌گیر</h3>
                    <p class="text-slate-600 dark:text-slate-400 leading-relaxed mb-8 flex-grow">
                        حمل تخصصی با سیستم چرخ‌گیر هیدرولیک بدون هیچ‌گونه آسیب به بدنه، سپر و جلوبندی خودرو.
                    </p>
                    <div class="border-t border-gray-100 dark:border-white/5 pt-6 mt-auto">
                        ...
                        <span class="text-2xl font-black text-primary">۴۰۰,۰۰۰ <span
                                class="text-sm font-normal text-slate-500 dark:text-slate-400">تومان</span></span>
                    </div>
                </div>
                <div
                    class="bg-white dark:bg-card-dark p-8 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-xl dark:hover:shadow-primary/5 transition-all group flex flex-col h-full">
                    <div
                        class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
                        <span
                            class="material-symbols-outlined text-primary group-hover:text-background-dark text-4xl">build</span>
                    </div>
                    <h3 class="text-xl font-bold mb-4 text-slate-900 dark:text-white">مکانیک سیار</h3>
                    <p class="text-slate-600 dark:text-slate-400 leading-relaxed mb-8 flex-grow">
                        عیب‌یابی تخصصی و رفع نقص فنی در محل. تعمیرات موتور، سیستم تعلیق و تعویض قطعات مصرفی.
                    </p>
                    <div class="border-t border-gray-100 dark:border-white/5 pt-6 mt-auto">
                        <span class="text-sm text-slate-500 dark:text-slate-400 block mb-1">شروع قیمت از:</span>
                        <span class="text-2xl font-black text-primary">۲۵۰,۰۰۰ <span
                                class="text-sm font-normal text-slate-500 dark:text-slate-400">تومان</span></span>
                    </div>
                </div>
                <div
                    ...
                    <div
                        class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
                        <span
                            class="material-symbols-outlined text-primary group-hover:text-background-dark text-4xl">battery_charging_full</span>
                    </div>
                    <h3 class="text-xl font-bold mb-4 text-slate-900 dark:text-white">امداد باطری</h3>
                    <p class="text-slate-600 dark:text-slate-400 leading-relaxed mb-8 flex-grow">
                        باطری به باطری سریع و تست سلامت دینام. فروش و نصب انواع باطری با ضمانت‌نامه معتبر در محل.
                    </p>
                    <div class="border-t border-gray-100 dark:border-white/5 pt-6 mt-auto">
                        <span class="text-sm text-slate-500 dark:text-slate-400 block mb-1">شروع قیمت از:</span>
                        <span class="text-2xl font-black text-primary">۱۸۰,۰۰۰ <span
                                class="text-sm font-normal text-slate-500 dark:text-slate-400">تومان</span></span>
                    </div>
                </div>
                <div
                    ...
                    <div
                        class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
                        <span
                            class="material-symbols-outlined text-primary group-hover:text-background-dark text-4xl">tire_repair</span>
                    </div>
                    <h3 class="text-xl font-bold mb-4 text-slate-900 dark:text-white">پنچرگیری</h3>
                    <p class="text-slate-600 dark:text-slate-400 leading-relaxed mb-8 flex-grow">
                        تعویض لاستیک زاپاس، تنظیم باد و پنچرگیری تخصصی انواع خودروهای سواری و شاسی بلند.
                    </p>
                    <div class="border-t border-gray-100 dark:border-white/5 pt-6 mt-auto">
                        <span class="text-sm text-slate-500 dark:text-slate-400 block mb-1">شروع قیمت از:</span>
                        <span class="text-2xl font-black text-primary">۱۵۰,۰۰۰ <span
                                class="text-sm font-normal text-slate-500 dark:text-slate-400">تومان</span></span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-3 gap-12 items-center">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div
                            class="flex items-center gap-4 bg-slate-50 dark:bg-card-dark p-4 rounded-xl border border-gray-100 dark:border-white/5 hover:border-primary transition-colors">
                            <div
                            ...
                            <span class="font-bold text-slate-900 dark:text-slate-100">شمال تهران</span>
                        </div>
                        <div
                            class="flex items-center gap-4 bg-slate-50 dark:bg-card-dark p-4 rounded-xl border border-gray-100 dark:border-white/5 hover:border-primary transition-colors">
                            <div
                            ...
                            <span class="font-bold text-slate-900 dark:text-slate-100">غرب تهران</span>
                        </div>
                        <div
                            class="flex items-center gap-4 bg-slate-50 dark:bg-card-dark p-4 rounded-xl border border-gray-100 dark:border-white/5 hover:border-primary transition-colors">
                            <div
                            ...
                            <span class="font-bold text-slate-900 dark:text-slate-100">کرج و حومه</span>
                        </div>
                        <div
                            class="flex items-center gap-4 bg-slate-50 dark:bg-card-dark p-4 rounded-xl border border-gray-100 dark:border-white/5 hover:border-primary transition-colors">
                            <div
                            ...
                            <span class="font-bold text-slate-900 dark:text-slate-100">آزادراه تهران-قم</span>
                        </div>
                        <div
                            class="flex items-center gap-4 bg-slate-50 dark:bg-card-dark p-4 rounded-xl border border-gray-100 dark:border-white/5 hover:border-primary transition-colors">
                            <div
                            ...
                            <span class="font-bold text-slate-900 dark:text-slate-100">پردیس و جاده جاجرود</span>
                        </div>
                    </div>
                    <p class="text-sm text-slate-500 dark:text-slate-400 flex items-center gap-2 italic">
                        <span class="material-icons text-sm">info</span>
                        امدادگران ما در تمامی اتوبان‌های اصلی مستقر هستند.
                    </p>
                </div>
            </div>
        </div>
